...
class MMaDADecodeConfig:
    ...
    cv_alpha: float = 0.1
    cv_mode: str = "cd_apc"  # cd_apc | cd_apc_v32 | cd_naive | legacy_score | off
    # cv_conf_source / cv_gate_tau are consumed by cv_mode in
    # {'cd_apc', 'cd_naive', 'cd_apc_v32'}. They decouple "which token CD picks"
...
def _pick_transfer_cv(
    ...
    if mode == "cd_apc_v32":
        from .cv_v32_dispatcher import pick_transfer_v32
        return pick_transfer_v32(
