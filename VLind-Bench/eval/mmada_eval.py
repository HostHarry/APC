...
EXTERNAL_ROOT = Path(
    os.environ.get("MMADA_EXTERNAL_ROOT", "/root/autodl-tmp")
).expanduser()
DEFAULT_DATA_PATH = (
    EXTERNAL_ROOT
    / "datasets"
...
DEFAULT_MMADA_ROOT = (
    REPOSITORY_ROOT / "MMaDA_DCD_cloud_bundle_20260711" / "MMaDA"
)
DEFAULT_MODEL_PATH = EXTERNAL_ROOT / "MMaDA-8B-MixCoT"
DEFAULT_VQ_MODEL_PATH = EXTERNAL_ROOT / "magvitv2"
